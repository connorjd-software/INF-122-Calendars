...
// Abstract factory for Calendar creation
abstract class CalendarFactory {
    public abstract Calendar createCalendar(User owner, String name);
}

// Concrete factory implementation
class DefaultCalendarFactory extends CalendarFactory {
    @Override
...
public class Calendar {
    ...
    // Constructor is now package-private to enforce factory usage
    Calendar(User owner, String name) {
        this.owner = owner;
        this.name = name;
        this.isPrivate = true;
    ...
    public void displayOptions() {
        CLI.getInstance().printCenteredOptions(name, "b = Back | a = Add event | e = Edit Event | t = Toggle Privacy | s = Share With | v = Change View");
    }
